...
class InferenceService(inference_service_pb2_grpc.InferenceServiceServicer):
    ...
    def test_process(self, request, context):
        ...
        custom_objects = {"ConversionLayer": resnet10.ConversionLayer,
        "IdentityBuildingBlock": resnet10.IdentityBuildingBlock,
        "ConvBuildingBlock": resnet10.ConvBuildingBlock }

        self.model.set_model(tf.keras.models.load_model('full_model.h5', custom_objects)) # restore model for test purpose (splitted again)
...
class SubModel:
    def __init__(self):
        ...
        "IdentityBuildingBlock": resnet10.IdentityBuildingBlock,
        "ConvBuildingBlock": resnet10.ConvBuildingBlock }
        self.model = tf.keras.models.load_model('full_model.h5', custom_objects)
